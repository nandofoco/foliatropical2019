$(document).ready(function(){
    ...
    $escolhaDia.find('#check-dia.checkbox ul input[name="dia"]').change(function() {
        ...
        $.post(site + "br/carrinho/selecionar/", {
            dia: dia
        }, function(resposta) {
            if(resposta.sucesso) {
                ...
                if(dia == 1038) {
                    swal({                    
                        title: "Em breve!",
                        text: "Os ingressos de 02 de Março ainda não estão a venda, em breve teremos ingressos disponíveis",
                        html: true,
                        type: "error"
                    });
                } else {
                    swal({                    
                        title: "Ingressos não disponíveis pelo site",
                        text: " Entre em contato através de nosso Whatsapp 21 99311-5550, atendimento@grupopacifica.com.br ou através do telefone 21 3202-6000.",
                        html: true,
                        type: "error"
                    });
                }
