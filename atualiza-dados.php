...
// 	}
	...
	// 	{
	// 		echo '<script type="text/javascript">location.href="https://ingressos.foliatropical.com.br/'.$lg.'/ingressos/";</script>';
	// 	}
	// 	else if ($_SESSION['plataforma'] == 'atual')
	// 	{
	// 		echo '<script type="text/javascript">location.href="https://ingressos.foliatropical.com.br/compras/";</script>';
	// 	}
