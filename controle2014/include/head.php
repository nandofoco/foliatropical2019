...
<link rel="stylesheet" type="text/css" href="<? echo SITE; ?>css/easy-autocomplete.min.css"> 
...
<script type="text/javascript" src="<? echo SITE; ?>js/jquery.easy-autocomplete.min.js"></script> 
