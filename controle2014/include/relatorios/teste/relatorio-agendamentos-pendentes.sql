...
DECLARE @loja TABLE (LO_COD INT, LO_CLIENTE INT, LO_VENDEDOR INT, LO_FORMA_PAGAMENTO INT, LO_VALOR_TOTAL DECIMAL(10,2), LO_DATA_COMPRA DATETIME, LO_PAGO TINYINT, LO_DELIVERY TINYINT, LO_RETIRADA VARCHAR(255), LO_CLI_PERIODO VARCHAR(255), LO_CLI_DATA_ENTREGA DATETIME);

INSERT INTO @loja (LO_COD, LO_CLIENTE, LO_VENDEDOR, LO_FORMA_PAGAMENTO, LO_VALOR_TOTAL, LO_DATA_COMPRA, LO_PAGO, LO_DELIVERY, LO_RETIRADA, LO_CLI_PERIODO, LO_CLI_DATA_ENTREGA)
SELECT LO_COD, 
LO_CLIENTE,
LO_VENDEDOR, 
LO_FORMA_PAGAMENTO, 
...
DECLARE @loja_total TABLE (LO_COD INT, LO_CLIENTE INT, LO_VENDEDOR INT, LO_FORMA_PAGAMENTO INT, LO_VALOR_TOTAL DECIMAL(10,2), LO_DATA_COMPRA DATETIME, LO_PAGO TINYINT, LO_DELIVERY TINYINT, LO_RETIRADA VARCHAR(255), LO_CLI_PERIODO VARCHAR(255), LO_CLI_DATA_ENTREGA DATETIME);

INSERT INTO @loja_total (LO_COD, LO_CLIENTE, LO_VENDEDOR, LO_FORMA_PAGAMENTO, LO_VALOR_TOTAL, LO_DATA_COMPRA, LO_PAGO, LO_DELIVERY, LO_RETIRADA, LO_CLI_PERIODO, LO_CLI_DATA_ENTREGA)
SELECT LO_COD, 
LO_CLIENTE, 
LO_VENDEDOR,
LO_FORMA_PAGAMENTO, 
...
MAX(ISNULL(CASE WHEN (l.LO_DELIVERY=0 AND l.LO_RETIRADA IS NOT NULL) THEN UPPER(l.LO_CLI_PERIODO) ELSE '' END, '')) AS 'PERÍODO RETIRADA',
