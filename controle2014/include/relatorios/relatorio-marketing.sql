...
DECLARE @clientes TABLE (CODPARC INT, NOMEPARC VARCHAR(255), EMAIL VARCHAR(255), SEXO VARCHAR(5), FAX VARCHAR(20), TELEFONE VARCHAR(20), DDD VARCHAR(20), DDD_CELULAR VARCHAR(20), DDI VARCHAR(20), DDI_CELULAR VARCHAR(20), ORIGEM VARCHAR(40));

INSERT INTO @clientes (CODPARC, NOMEPARC, EMAIL, SEXO, FAX, TELEFONE, DDD, DDD_CELULAR, DDI, DDI_CELULAR, ORIGEM)
SELECT CODPARC, NOMEPARC, EMAIL, SEXO, FAX, TELEFONE, DDD, DDD_CELULAR, DDI, DDI_CELULAR, ORIGEM FROM [parceiros].[dbo].[TGFPAR] WHERE CLIENTE='S';
...
MAX(ISNULL(QTDE, '')) AS QUANTIDADE,
-- MAX(ISNULL(ESPECIFICO, '')) AS ESPECIFICO,
MAX(ISNULL(TID, '')) AS TID,
...
FROM (
	...
	LEFT JOIN [parceiros].[dbo].[clientes_enderecos] enderecos ON enderecos.CE_CLIENTE = l.LO_CLIENTE
