...
if(!empty($cod)) {
	...
	if(sqlsrv_num_rows($sql_co) > 0) {
		...
		$sql_up = sqlsrv_query($conexao, "UPDATE TOP (1) loja SET LO_XML='$StrPedido',LO_TID='$tid', LO_STATUS_TRANSACAO='$co_status' WHERE LO_COD=$cod", $conexao_params, $conexao_options);
