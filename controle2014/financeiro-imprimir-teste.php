...
<body <? if ($entrega){ echo 'class="entrega"'; } ?>>
				...
				<tr>
					...
					<td>
						...
						if($cartao_credito) {
							...
							switch (true) {
								case $loja_antifraude_score<30:
									$antifraude_texto = "(Risco Baixo)";
									break;
								case $loja_antifraude_score<60:
									$antifraude_texto = "(Risco Médio)";
									break;

								case $loja_antifraude_score<90:
									$antifraude_texto = "(Risco Alto)";
									break;

								case $loja_antifraude_score<100:
									$antifraude_texto = "(Risco Crítico)";
									break;
								
								default:
									$antifraude_texto = "(Risco Desconhecido)";
									break;
							}

							if($antifraudeAprovado){
								echo '<br/>Anti Fraude: Analisado<br/>';
								echo 'Score: '.number_format($loja_antifraude_score, 2, ',', '.')."% ".$antifraude_texto;
							}else if($antifraudeReprovado){
								echo '<br/>Anti Fraude: Reprovado<br/>';
								echo 'Score: '.number_format($loja_antifraude_score, 2, ',', '.')."% ".$antifraude_texto;
							} else if($antifraudeAnalisando){
								echo '<br/>Anti Fraude: Analisando<br/>';
							} else {
								echo '<br/>Anti Fraude: Não Analisado<br/>';
							}
	...
	<section class="informacoes-retirada float secao">
		<!-- <h3>Retirada dos ingressos do Candybox, Terrasse e Folia Tropical + Kit Folião (utilização da camisa passaporte é obrigatória):</h3>
		<p><strong>Credenciamento:</strong> Monte Líbano - Av. Borges de Medeiros, 701 - Leblon, Rio de Janeiro.</p>
		<p><strong>Datas e Horários:</strong></p>
		<p>03/02 - 04/02 - 11/02 - 12/02: das 14:00 as 22:00</p>
		<p>05/02 - 06/02 - 07/02 - 08/02 - 13/02: das 14:00 as 00:00</p> -->
	...
	<section class="informacoes-retirada float last secao">
		<!-- <h3>Retirada dos ingressos de Arquibancadas, Frisas e Camarotes + Kit Folião:</h3>
		<p><strong>Credenciamento:</strong> Monte Líbano - Av. Borges de Medeiros, 701 - Leblon, Rio de Janeiro.</p>
		<p><strong>Datas e Horários:</strong></p>
		<p>03/02 - 04/02 - 11/02 - 12/02: das 14:00 as 22:00</p>
		<p>05/02 - 06/02 - 07/02 - 08/02 - 13/02: das 14:00 as 00:00</p> -->
