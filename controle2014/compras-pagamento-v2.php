...
<section id="conteudo">
	...
	<section class="padding">
		...
		<section id="compra-pagamento">
				...
				<? if (!$loja_desconto){ ?>
					<? if ($cupom_cod > 0){ ?>					
						<span class="cupom">
							...
							<? if ($cupom_delete){ ?><a href="<? echo SITE; ?>compras/pagamento/v2/cupom/remover/<? echo $cupom_cod; ?>/<? echo $cod; ?>/" class="excluir confirm" title="Deseja remover o cupom &rdquo;<? echo $cupom_nome; ?>&ldquo;">&times;</a><? } ?>
						</span>
					<? } else { ?>
					<form class="controle" id="form-cupom-pagamento" action="<? echo SITE; ?>compras/pagamento/v2/cupom/" method="post">
						<input type="hidden" name="cod" value="<? echo $cod; ?>" />
		    ...
		    <form class="form-padrao controle" id="form-compra-pagamento" action="<? echo SITE; ?>compras/pagamento/cielo/<?php echo $cod ?>" method="post">
				<input type="hidden" name="cod" value="<? echo $cod; ?>"/>
				<input type="hidden" name="cliente" value="<? echo $loja_cliente; ?>" />
				...
				<input type="submit" class="submit cielo" value="Pagar com cartão"/>
				<!-- <a href="<?php echo SITE.'compras/pagamento/v2/cartao/'.$cod ?>" class="submit cielo" style="float: right;">Pagar com cartão</a> -->
