...
require_once 'controle2014/cielo/includes/pedido.php';
require_once 'controle2014/cielo/includes/logger.php';
	...
	if(sqlsrv_num_rows($sql_compra) > 0) {
		...
		if(!empty($co_xml)){
			...
			if($co_status==9) 
			{
				...
				$sql_log = sqlsrv_query($conexao, "INSERT INTO loja_excluidas (LE_COMPRA, LE_USUARIO, LE_DATA) VALUES ('$cod', '$co_cliente', GETDATE())", $conexao_params, $conexao_options);
...
<html>
	...
	<script type="text/javascript">
		...
		window.location.href="<? echo SITE; ?>minhas-compras/";
	</script>
	</body>
</html>
<?
