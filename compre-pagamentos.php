							...
							?>
								<tr <? if ($loja_block){ echo 'class="block"'; } ?>>	
									...
									<td class="ctrl financeiro">
										...
										// Quando tiver com a tradução 
											<a href="https://ingressos.foliatropical.com.br/compras/<? echo $link_lang; ?>pagamento/<? echo $loja_cod; ?>/" class="liberar pagar confirm" title="<? echo $lg['minhas_compras_deseja_pagar'].$loja_cod; ?>?" data-sim="<? echo $lg['minhas_compras_sim']; ?>" data-cancelar="<? echo $lg['minhas_compras_cancelar']; ?>"><? echo $lg['minhas_compras_pagar']; ?></a> */
										?>

										<a href="<? echo SITE; ?>cancelar-compra-cliente/<? echo $loja_cod; ?>/" class="excluir-compra" title="<? echo $lg['cancelar-compra']; ?>" onclick="return confirm('<? echo $lg['cancelar-compra']; ?>');"></a>											
