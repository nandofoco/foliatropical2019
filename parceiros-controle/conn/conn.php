...
if ($_SERVER['SERVER_NAME'] == "server" || $_SERVER['SERVER_NAME'] == "localhost"){
	...
	define ("BASE","\\\\server\\web\\foliatropical\\parceiros-controle\\");
	define ("SITE", "http://server/foliatropical/parceiros-controle/");
	...
	define ("BASE", "C:\\web\\ingressos.foliatropical.com.br\\public_html\\parceiros-controle\\");
	define ("SITE", "http".$s."://ingressos.foliatropical.com.br/parceiros-controle/");
