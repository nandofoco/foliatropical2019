	...
	<nav id="principal">
		<ul class="menu">
			...
			<li class="drop">
				...
				<ul>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#camarote"><? echo $lg['folia_camarote']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#samba"><? echo $lg['folia_shows']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#servicos"><? echo $lg['folia_servicos']; ?></a></li>
					...
					<!--<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>"><? echo $lg['folia_super_folia']; ?></a></li>-->
