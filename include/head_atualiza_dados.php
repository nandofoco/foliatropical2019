...
<link rel="stylesheet" type="text/css" href="<? echo SITE; ?>css/header.css"/>
...
<? if(defined('PGHOTSITE')) { ?><link rel="stylesheet" type="text/css" href="<? echo SITE; ?>css/index/index.css"/><? } ?>
<? if(defined('PGSUPERFOLIA')) { ?><link rel="stylesheet" type="text/css" href="<? echo SITE; ?>css/superfolia/superfolia.css"/><? } ?>
...
<script type="text/javascript" src="<? echo SITE; ?>js/head_atualiza.js"></script>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-109101507-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-109101507-1');
</script>
...
<body <? if (defined('PGRESPOSTA')){ echo 'class="resposta"'; } ?> itemscope itemtype="//schema.org/WebPage">
<input type="hidden" id="base-site" value="<?php echo SITE; ?>">
