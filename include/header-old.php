<header id="topo" <? if (defined('PGINDEX')){ echo 'class="index parallaxouter"'; } ?>>
	...
	<!-- <?php echo $_SESSION['SessionID']; ?> -->
		<ul class="menu">
			...
			<li class="drop">
				<a href="<? echo SITE.$link_lang; ?>#folia" class="drop rolagem"><? echo $lg['menu_folia_titulo']; ?></a>
				<ul>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#camarote-lounge"><? echo $lg['folia_camarote']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#shows"><? echo $lg['folia_shows']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#visao"><? echo $lg['folia_visao']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#sinta-emocao"><? echo $lg['folia_video']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#all-inclusive"><? echo $lg['folia_servicos']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#espacos"><? echo $lg['folia_espacos']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#transporte"><? echo $lg['folia_transporte']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#programacao"><? echo $lg['folia_programacao']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#galeria"><? echo $lg['folia_fotos']; ?></a></li>
				</ul>
			</li>
			<li><a href="<? echo SITE.$link_lang; ?>superfolia/"><? echo $lg['menu_superfolia']; ?></a></li>
			<li class="drop">
				<a href="#" class="drop"><? echo $lg['menu_produtos']; ?></a>
				<ul>
					<!-- <li><a href="<? echo SITE.$link_lang; ?>folia-tropical/"><? echo $lg['escolha_folia_tropical']; ?></a></li> -->
					<li><a href="<? echo SITE.$link_lang; ?>"><? echo $lg['escolha_folia_tropical']; ?></a></li>
					<li><a href="<? echo SITE.$link_lang; ?>camarotes/"><? echo $lg['escolha_camarote']; ?></a></li>
					<li><a href="<? echo SITE.$link_lang; ?>camarote-corporativo/"><? echo $lg['escolha_camarote_corporativo']; ?></a></li>
					<li><a href="<? echo SITE.$link_lang; ?>arquibancadas/"><? echo $lg['escolha_arquibancadas']; ?></a></li>
					<li><a href="<? echo SITE.$link_lang; ?>frisas/"><? echo $lg['escolha_frisas']; ?></a></li>
					...
					<!-- <li><a href="<? echo SITE.$link_lang; ?>cadeiras-numeradas/"><? echo $lg['escolha_cadeiras']; ?></a></li> -->
				</ul>
			</li>
			<li><a href="<? echo SITE.$link_lang; ?>noticias-carnaval/"><? echo $lg['menu_blog']; ?></a></li>
			<!--<li><a href="<? echo SITE.$link_lang; ?>guia-do-carnaval"><? echo $lg['menu_guia_carnaval']; ?></a></li>-->
			<li><a href="<? echo SITE.$link_lang; ?>atendimento/"><? echo $lg['menu_atendimento']; ?></a></li>
			<li><a href="<? echo SITE.$link_lang; ?>lounge-faq/">Dúvidas</a></li>
			<li><a class="ingress" href="<? echo SITE.$link_lang.$lg['link_compre']; ?>"><? echo $lg['menu_loja']; ?></a></li>
			<?
			if(checklogado()) {
			...
			<li class="usuario drop <? echo strtolower($session_language); ?>">
				<span class="drop"><? echo utf8_encode($usuario_nome); ?></span>
				<ul>
			...
			<li class="botao first"><a href="<? echo SITE.$link_lang.$lg['link_compre']; ?>" class="carrinho"><? echo count($_SESSION['compra-site']); ?></a></li>
			<?
			} else {
			?>
			...
			<li class="social">
				<a href="<? echo SITE.$link_lang; ?>atendimento/" target="_blank" class="whatsapp"><span></span></a>
