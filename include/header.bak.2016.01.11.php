		...
		<ul class="menu">
			...
			<li class="drop">
				...
				<ul>
					...
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#sinta-emocao"><? echo $lg['folia_sinta_emocao']; ?></a></li>
					...
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#video"><? echo $lg['folia_video']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#transporte"><? echo $lg['folia_transfer']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#credenciamento"><? echo $lg['folia_credenciamento']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#programacao"><? echo $lg['folia_programacao']; ?></a></li>
					<li><a class="rolagem" href="<? echo SITE.$link_lang; ?>#confira"><? echo $lg['folia_confira']; ?></a></li>
				</ul>
			</li>
			<li class="drop">
			...
			<li><a class="ingress" href="<? echo SITE.$link_lang; ?>ingressos-carnaval-2016/"><? echo $lg['menu_loja']; ?></a></li>
			<?
			if(checklogado()) {
			...
			<li class="botao first"><a href="<? echo SITE.$link_lang; ?>ingressos-carnaval-2016/" class="carrinho"><? echo count($_SESSION['compra-site']); ?></a></li>
			<?
			} else {
			?>
			<li class="login"><a href="<? echo SITE.$link_lang; ?>login-cadastro-site/" ><? echo $lg['menu_login_ou_cadastro']; ?></a></li>
			<? 
			}
			?>
			<li class="botao">
